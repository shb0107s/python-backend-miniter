...
def test_get_user_id_and_password(user_dao):
    ...
    user_credential = user_dao.get_user_id_and_password(email='shb0107@gmail.com')
...
def test_save_and_get_profile_picture(user_dao):
    ...
    # profile picture url을 저장
    expected_profile_picture = "https://s3.ap-northest-2.amazonaws.com/test/profile.png"
    user_dao.save_profile_picture(expected_profile_picture, user_id)

    # profile picture url을 읽는다
